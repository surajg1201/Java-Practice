...
//    https://leetcode.com/problems/find-in-mountain-array/
    // make some changes on leet code later on to run this(after oops)
...
//        and if we are that only one item is remaining, hence cuz of above line that is the best possible ans
